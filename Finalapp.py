...
def main():
    ...
    if selected == "Projects":
            ...
            if menu_Pre_Exp == 'Exploratoriy Data Analysis' and selected == "Projects":
                    ...
                    if menu_Pre == 'Checking ML Method And Accuracy' and selected == "Projects":
                    ...
                    elif menu_Pre == 'Prediction' and selected == "Projects":
                        st.title('Prediction')
                        st.markdown("""
                               #### Kindly select from left Menu.
                                    """)
                        ...
                        if menu_Tex_File == 'Paste/Write Text' and selected == "Projects":
                        ...
                        elif menu_Tex_File == 'Upload File(.docx,.pdf)' and selected == "Projects":
