...
def main():
    ...
    if selected == "Projects":
            ...
            menu_list = ['Exploratoriy Data Analysis',"Prediction With Machine Learning"]
            menu = st.sidebar.radio("Menu", menu_list)

            #EDA On Document File
            if menu == 'Exploratoriy Data Analysis':
                    st.title('Exploratoriy Data Analysis')

                    df = pd.read_csv('Resume.csv')
                    menu_list = ['None', 'Label Analysis','Character & Word Distribution','N-Gram Analysis','Sentiment Analysis','Part Of Speech & Top Common Words','Wordcloud','Named Entity Recognition (NER)','Topic Model Analysis']
                    menu = st.sidebar.radio("Menu", menu_list)
                    ...
                    elif menu == 'Label Analysis':
                        label_analysis(df)

                    #Distribution    
                    elif menu == 'Character & Word Distribution':
                        char_word_dist(df)

                    #N-gram Analysis
                    elif menu == 'N-Gram Analysis':
                        ngram_ana(df)
                    ...
                    #POS & Top Words
                    elif menu == 'Part Of Speech & Top Common Words':
                        pos_common_words(df)
                    ...
                    #Topic Modeling
                    elif menu == 'Topic Model Analysis':
                        preprocess_news(df)

            elif menu == "Prediction With Machine Learning":
                    st.title('Prediction With Machine Learning')
                    
                    menu_list = ['Checking ML Method And Accuracy' , 'Prediction' ]
                    ...
                    if menu == 'Prediction':
                            ...
                            if menu == 'Paste/Write Text':
                                message = st.text_area("Enter Text Only PeopleSoft, SQL Developer, React JS, Workday & Internship Resume Accept", "Type Here ..Under Double Quotes")
                                input1=[message]
                                if st.button("Analyze"):
                            ...
                            if menu == 'Upload File(.txt,.docx,.pdf)':
                                    ...
                                    docx_file = st.file_uploader("Upload File  Only PeopleSoft, SQL Developer, React JS, Workday & Internship Resume Accept",type=['txt','docx','pdf'])
